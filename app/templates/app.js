angular.module("<%= appname %>", ['basic.app', 'shop'])
    .config(['$routeProvider', function ($routeProvider) {
        $routeProvider
            ...
            .when('/:locale/admin', {templateUrl: 'partials/admin.html'})
            .when('/:locale/404', {templateUrl: 'partials/404.html'})
            .otherwise({redirectTo: '/404'});
    }])
    .controller('MainCtrl', ['$scope', '$location', 'activeUserHasPermission', 'publicConfigReader', 'config',
        function ($scope, $location, activeUserHasPermission, publicConfigReader, config) {
